...
const discrepancyTypes = [
  "Quantity Loss During Transport",
  "Spillage",
  "Suspected Theft",
  "Measurement Error",
  "Low Fat / SNF",
  ...
  return (
    <div className="p-6 text-[#1F2A44]">
      ...
      <p className="mt-1 text-sm text-[#5B6B7F]">
        Final dairy audit step for each trip: expected vs received, root-cause tagging, and penalty decision.
      </p>
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <section className="rounded-xl border border-[#D7E4FF] bg-white p-5 shadow-[0_4px_12px_rgba(15,41,74,0.08)]">
          ...
          <p className="mt-1 text-xs text-[#64748B]">
            This is the transport accountability checkpoint before accounts settlement.
          </p>
